--[[
	Historian has antique weapons from WWII et al.
...
-- Carbines/SMGs
ACT3_BlackMarket:LoadItemToMerchant({ -- C96 Carbine
   merchant = "Historian",
   category = "Weapons",
...
-- Rifles
ACT3_BlackMarket:LoadItemToMerchant({ -- K98
   merchant = "Historian",
   category = "Weapons",
   class = "act3_k98",
   quantity = 1,
...
-- Assault Rifles
ACT3_BlackMarket:LoadItemToMerchant({ -- StG44
   merchant = "Historian",
   category = "Weapons",
   class = "act3_stg44",
   quantity = 1,
